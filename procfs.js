...
(function() {
  var FORMATS, addChild, diskstats, format, fs, k, lazy, maybeNum, meminfo, nc, numeric, onUpdate, partitions, proc, procCache, qw, returnUpdate, stat, updateCache, updateProc, updateProcErr, updating, v, vmstat, _, _ref;
