...
(function() {
  var FORMATS, addChild, diskstats, format, fs, lazy, maybeNum, meminfo, nc, numeric, onUpdate, proc, procCache, qw, returnUpdate, stat, updateCache, updateProc, updateProcErr, updating, vmstat, _;
